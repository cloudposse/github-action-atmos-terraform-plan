...
https://atmos.tools/deprecated/github-actions/atmos-terraform-plan for the equivalent built-in
command (`atmos terraform plan`) and how to move your workflow over.
